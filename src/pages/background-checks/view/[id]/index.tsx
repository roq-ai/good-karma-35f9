...
import { getBackgroundCheckById } from 'apiSdk/background-checks';
...
function BackgroundCheckViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Background Check Detail View
          </Text>
          {hasAccess('background_check', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/background-checks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
