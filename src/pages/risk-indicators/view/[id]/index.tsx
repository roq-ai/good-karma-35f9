...
import { getRiskIndicatorById } from 'apiSdk/risk-indicators';
...
function RiskIndicatorViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Risk Indicator Detail View
          </Text>
          {hasAccess('risk_indicator', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/risk-indicators/edit/${data?.id}`} passHref legacyBehavior>
              <Button
