...
import { deleteEmployeeById, createEmployee } from 'apiSdk/employees';
...
function CompanyViewPage() {
  ...
  const employeeHandleCreate = async () => {
    setCreateError(null);
    try {
      await createEmployee({ company_id: id, user_id: employeeUserId });
            ...
            <Box>
              <Stack spacing={2} mb={8}>
                ...
                <Flex gap={5} alignItems="flex-end">
                  <Box flex={1}>
                    <UserSelect name={'employee_user'} value={employeeUserId} handleChange={setEmployeeUserId} />
                  </Box>
                  <Button colorScheme="blue" mt="4" mr="4" onClick={employeeHandleCreate} isDisabled={!employeeUserId}>
                    Create
                  </Button>
                </Flex>
                <TableContainer>
