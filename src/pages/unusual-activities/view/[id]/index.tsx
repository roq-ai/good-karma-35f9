...
import { getUnusualActivityById } from 'apiSdk/unusual-activities';
...
function UnusualActivityViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Unusual Activity Detail View
          </Text>
          {hasAccess('unusual_activity', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/unusual-activities/edit/${data?.id}`} passHref legacyBehavior>
              <Button
