...
import { getFileAccessById } from 'apiSdk/file-accesses';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            File Access Detail View
          </Text>
          {hasAccess('file_access', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/file-accesses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
